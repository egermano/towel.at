...
<head>
	...
	<meta property="og:title" content="Towel.at"/>
...
<body>
	...
	<div id="main" role="main">
		<div class="content">
			...
			<p><small>Type a URL to put a towel.at.</small></p>
			<div class="input-append">
					<input class="span2" id="appendedInputButton" name="url" style="width:497px" type="url" placeholder="URL" required><button class="btn" id="urlForm" type="button">Go!</button>
        	</div>
		</div>
	</div>
	<footer>
